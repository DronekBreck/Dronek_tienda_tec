...
<body>
    <?php
        ...
        $query = "select p.id as id, p.nombre as nombre,p.precio as precio,c.nombre as categoria from productos p inner join categorias c on c.id = p.categoria_id order by p.nombre;";
